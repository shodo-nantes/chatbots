//Imports pour le fichier json ou sont les user ET DateTime pour la lib afin de gerer les dates
...
function greetsBirthdays() {
    ...
    //dans filter on appelle la fonction comparesUserDateToToday
    ...
    //Comme on doit souhaiter tous les jours l'anniversaire de Michel, on l'ajoute automatiquement au tableau greeting
